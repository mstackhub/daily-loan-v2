...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-dvh max-w-lg mx-auto relative bg-gradient-dark">
      ...
      <div className="fixed inset-0 max-w-lg mx-auto pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/2 -right-32 w-72 h-72 bg-indigo-600/8 rounded-full blur-3xl" />
      </div>
